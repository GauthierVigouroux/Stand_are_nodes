...
# iso_net = Network(height='1500px', width='75%',font_color='black',directed=True, neighborhood_highlight=True, select_menu=True)
...
#A désactiver si besoin d'utiliser des paramètres
